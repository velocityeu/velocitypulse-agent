 ...
 */
export async function arpScan(cidr: string, logger: Logger): Promise<DiscoveredDevice[]> {
 ...
 */
export async function populateArpCache(cidr: string, logger: Logger): Promise<void> {
  const platform = process.platform
